...
const uint16_t kFujitsuAcHdrMark = 3400;
const uint16_t kFujitsuAcHdrSpace = 1620;
const uint16_t kFujitsuAcBitMark = 414;
const uint16_t kFujitsuAcOneSpace = 1236;
const uint16_t kFujitsuAcZeroSpace = 417;
const uint16_t kFujitsuAcMinGap = 8100;
