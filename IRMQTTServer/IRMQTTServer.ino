...
char MqttServer[kHostnameLength + 1] = "10.0.0.254";
...
void handleAdmin(void) {
  String html = htmlHeader(F("IRMQTT-Control"));
  html += htmlMenu();
...
void setup_wifi(void) {
  ...
  if (!wifiManager.autoConnect("IRMQTT", ""))
    // Reboot. A.k.a. "Have you tried turning it Off and On again?"
    //    blinkity(2, 6); //ADD BY HUEX
